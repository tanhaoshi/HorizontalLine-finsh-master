...
//                                    //这个判断其实是中间的点
//                                       Log.i("3699点击:" , "eeeeeeeeeeee");
//                                    mScroller.startScroll(mScroller.getFinalX(), mScroller.getCurrY(),
//                                            0, 0, 400);
//                                } else {
//                                    //当抬起的x的值 小于 屏幕宽度除以5 平均分成了5份
//                                    int space = mMeasureWidth / 5;
//                                    Log.i("3699点击","space = " + space);
//                                    Log.i("3699点击","mUpX = " + mUpX);
...
//                                }
                                ...
                                //总共五个区域 用户点击的话 肯定是去点5个点上 所以我只要判断这5个点就行了
                                int space = mMeasureWidth / 5;
                                Log.i("3699点击","mUpx = " + mUpX);
                                Log.i("3699点击","mMeasureWidth - mUpX = "+(mMeasureWidth - mUpX));
                                if((mMeasureWidth - mUpX) <= space){
                                    mScroller.startScroll(mScroller.getFinalX(), mScroller.getCurrY(),
                                                (mMeasureWidth / 5) * 2, 0, 400);
                                }

                                if((mMeasureWidth - mUpX) <= 2*space && (mMeasureWidth - mUpX) > space){
                                    mScroller.startScroll(mScroller.getFinalX(), mScroller.getCurrY(),
                                            (mMeasureWidth / 5), 0, 400);
                                }

                                if(mUpX <= 2*space && mUpX > space ){
                                    mScroller.startScroll(mScroller.getFinalX(), mScroller.getCurrY(),
                                            -(mMeasureWidth / 5), 0, 400);
                                }
...
//3699点击
    ...
    private void drawImaginaryLine(Canvas canvas){
        ...
        canvas.drawLine(mMeasureWidth/2, mMeasureHeight, mMeasureWidth/2, mMeasureHeight, paint);
    }
